...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("BitcoinTitanium-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("BitcoinTitanium-net");
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("BitcoinTitanium-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("BitcoinTitanium-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("BitcoinTitanium-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("BitcoinTitanium-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BitcoinTitanium is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("BitcoinTitanium-start");
