...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BITT");
    case mBTC: return QString("mBITT");
    case uBTC: return QString::fromUtf8("μBITT");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("BITTs"));
    case mBTC: return QString(QObject::tr("Milli-BITTs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-BITTs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
