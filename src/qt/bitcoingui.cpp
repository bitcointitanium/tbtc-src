...
{
    resize(850, 550);
    setWindowTitle(tr("BitcoinTitanium") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a BitcoinTitanium address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About BitcoinTitanium"), this);
    aboutAction->setStatusTip(tr("Show information about BitcoinTitanium"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitcoinTitanium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitcoinTitanium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitcoinTitanium addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your BitcoinTitanium addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("BitcoinTitanium client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("BitcoinTitanium client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitcoinTitanium network", "", count));
}
...
{
    QString strTitle = tr("BitcoinTitanium") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BitcoinTitanium address or malformed URI parameters."));
    }
